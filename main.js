...
function FunctionsQuickstart() {
  ...
  this.firstNumber = document.getElementById('first-number1');
  this.secondNumber = document.getElementById('second-number1');
  this.firstNumber = document.getElementById('first-number2');
  this.secondNumber = document.getElementById('second-number2');
  this.firstNumber = document.getElementById('first-number3');
  this.secondNumber = document.getElementById('second-number3');
  this.addNumbersButton = document.getElementById('send-add-button');
  this.subNumbersButton = document.getElementById('send-sub-button');
  this.mulNumbersButton = document.getElementById('send-mul-button');
  this.divNumbersButton = document.getElementById('send-div-button');
  ...
  this.subNumbersButton.addEventListener('click', this.subNumbers.bind(this));
  this.mulNumbersButton.addEventListener('click', this.mulNumbers.bind(this));
  this.divNumbersButton.addEventListener('click', this.divNumbers.bind(this));
...
FunctionsQuickstart.prototype.subNumbers = function() {
  var firstNumber = parseFloat(this.firstNumber.value);
  var secondNumber = parseFloat(this.secondNumber.value);
  var subNumbersButton = this.subNumbersButton;
  subNumbersButton.disabled = true;
  // [START callsubFunction]
  var sendNotification = firebase.functions().httpsCallable('subNumbers');
  sendNotification({firstNumber: firstNumber, secondNumber: secondNumber}).then(function(result) {
    console.log('Cloud Function called successfully.', result);
    // Read results of the Cloud Function.
    var firstNumber = result.data.firstNumber;
    ...
    window.alert('Here is the result of the formula: ' + firstNumber + ' '
        + operator + ' ' + secondNumber + ' = ' + operationResult);
    subNumbersButton.disabled = false;
    // [END_EXCLUDE]
  }).catch(function(error) {
    // Getting the Error details.
    var code = error.code;
...
FunctionsQuickstart.prototype.mulNumbers = function() {
  var firstNumber = parseFloat(this.firstNumber.value);
  var secondNumber = parseFloat(this.secondNumber.value);
  var mulNumbersButton = this.mulNumbersButton;
  mulNumbersButton.disabled = true;
  // [START callmulFunction]
  var sendNotification = firebase.functions().httpsCallable('mulNumbers');
  sendNotification({firstNumber: firstNumber, secondNumber: secondNumber}).then(function(result) {
    console.log('Cloud Function called successfully.', result);
    // Read results of the Cloud Function.
    var firstNumber = result.data.firstNumber;
    ...
    window.alert('Here is the result of the formula: ' + firstNumber + ' '
        + operator + ' ' + secondNumber + ' = ' + operationResult);
    mulNumbersButton.disabled = false;
    // [END_EXCLUDE]
  }).catch(function(error) {
    // Getting the Error details.
    var code = error.code;
...
FunctionsQuickstart.prototype.divNumbers = function() {
  var firstNumber = parseFloat(this.firstNumber.value);
  var secondNumber = parseFloat(this.secondNumber.value);
  var divNumbersButton = this.divNumbersButton;
  divNumbersButton.disabled = true;
  // [START calldivFunction]
  var sendNotification = firebase.functions().httpsCallable('divNumbers');
  sendNotification({firstNumber: firstNumber, secondNumber: secondNumber}).then(function(result) {
    console.log('Cloud Function called successfully.', result);
    // Read results of the Cloud Function.
    var firstNumber = result.data.firstNumber;
    ...
    window.alert('Here is the result of the formula: ' + firstNumber + ' '
        + operator + ' ' + secondNumber + ' = ' + operationResult);
    divNumbersButton.disabled = false;
    // [END_EXCLUDE]
  }).catch(function(error) {
    // Getting the Error details.
    var code = error.code;
